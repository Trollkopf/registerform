...
@section('content')
    ...
    @if (session('success'))
        <div class="container py-2  text-bg-success w-75 justify-content-center text-center">
            {{ session('success') }}</div>
    @endif
            ...
            <div class="d-flex justify-content-center align-content-center h-100 ">
                <div class="w-50 m-2">
                    <div class="btn-group @error('FPACLI') border border-danger border-5  @enderror" role="group"
                        ...
                        <input type="radio" class="btn-check " name="FPACLI" id="fra_electronica"
                            value="fra_electronica" autocomplete="off" />
                        <label class="btn btn-outline-primary align-content-center " for="fra_electronica">Envío factura
                            electrónica</label>

                        <input type="radio" class="btn-check" name="FPACLI" id="recibo_bancario"
                            value="recibo_bancario" autocomplete="off" />
                        <label class="btn btn-outline-primary align-content-center " for="recibo_bancario">Giro / Recibo
                            Bancario</label>

                        <input type="radio" class="btn-check" name="FPACLI" id="pagare" value="pagare"
                            autocomplete="off" />
                        <label class="btn btn-outline-primary align-content-center " for="pagare">Pagaré</label>

                        <input type="radio" class="btn-check" name="FPACLI" id="transferencia_bancaria"
                            value="transferencia_bancaria" autocomplete="off" />
                        <label class="btn btn-outline-primary align-content-center "
                            for="transferencia_bancaria">Transferencia Bancaria</label>
                    </div>
                </div>
                <div class="w-50 m-2">
